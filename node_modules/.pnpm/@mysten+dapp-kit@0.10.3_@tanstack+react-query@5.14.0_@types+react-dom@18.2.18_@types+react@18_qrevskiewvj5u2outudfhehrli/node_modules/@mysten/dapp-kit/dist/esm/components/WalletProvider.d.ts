...
export declare function WalletProvider({ preferredWallets, requiredFeatures, storage, storageKey, enableUnsafeBurner, autoConnect, theme, children, }: WalletProviderProps): import("react/jsx-runtime").JSX.Element;
